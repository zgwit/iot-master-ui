...
@Component({
  selector: 'app-element-edit-commands',
  templateUrl: './element-edit-commands.component.html',
  styleUrls: ['./element-edit-commands.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ElementEditCommandsComponent),
      multi: true
    }
  ]
})
export class ElementEditCommandsComponent implements OnInit, ControlValueAccessor {
  onChanged: any = () => {
  }
  onTouched: any = () => {
  }
