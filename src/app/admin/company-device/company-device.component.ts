...
@Component({
  selector: 'app-company-device',
  templateUrl: './company-device.component.html',
  styleUrls: ['./company-device.component.scss']
})
export class CompanyDeviceComponent implements OnInit {
  @Input() _id = '';
  ...
  load(): void {
    this.loading = true;
    this.rs.post(`company/${this._id}/device`, this.params).subscribe(res => {
      console.log('res', res);
      this.datum = res.data;
