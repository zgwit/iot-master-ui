...
@Component({
  selector: 'app-element-edit-validators',
  templateUrl: './element-edit-validators.component.html',
  styleUrls: ['./element-edit-validators.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ElementEditValidatorsComponent),
      multi: true
    }
  ]
})
export class ElementEditValidatorsComponent implements OnInit, ControlValueAccessor  {
  onChanged: any = () => {
  }
  onTouched: any = () => {
  }
